...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('dashboard.dashboard', compact('usulan_penelitian', 'penelitian_selesai', 'usulan_pengabmas', 'pengabmas_selesai', 'usulan_penelitian_baru', 'usulan_pengabmas_baru'))
    ...
    public function laporankemajuanpenelitian()
    {
        ...
        $laporan = DB::select('select tb_usulan_penelitian.nama_ketua, tb_usulan_penelitian.jenis_penelitian, tb_usulan_penelitian.judul_penelitian, tb_laporan_kemajuan_penelitian.tanggal, tb_laporan_kemajuan_penelitian.jenis_berkas, tb_laporan_kemajuan_penelitian.file, tb_laporan_kemajuan_penelitian.id, tb_laporan_kemajuan_penelitian.url
        FROM tb_usulan_penelitian
    ...
    {
        $usulan = DB::select('select * from tb_usulan_penelitian where id_dosen = "' . Auth::user()->nik . '" and status = "di terima"');
        $laporan = DB::select('select tb_usulan_penelitian.nama_ketua, tb_usulan_penelitian.jenis_penelitian, tb_usulan_penelitian.judul_penelitian, tb_laporan_akhir_penelitian.tanggal, tb_laporan_akhir_penelitian.jenis_luaran, tb_laporan_akhir_penelitian.file, tb_laporan_akhir_penelitian.luaran, tb_laporan_akhir_penelitian.lama_penelitian, tb_laporan_akhir_penelitian.lama_penelitian_riil, tb_laporan_akhir_penelitian.url, tb_laporan_akhir_penelitian.id
        FROM tb_usulan_penelitian
    ...
    public function plotreviewer()
    {
        ...
        GROUP by tb_reviewer_penelitian.id
        ORDER by tb_reviewer_penelitian.tanggal DESC');
        $usulanpenelitian = DB::select('select id_usulan, judul_penelitian from tb_usulan_penelitian where status = "pengajuan"');
    ...
    public function plotreviewerkemajuan()
    {
        ...
        GROUP by tb_reviewer_penelitian.id
        ORDER by tb_reviewer_penelitian.tanggal DESC');
        $usulanpenelitian = DB::select('select id_usulan, judul_penelitian from tb_usulan_penelitian where status = "di terima"');
        $plotpengabmas = DB::select('select users.name, users.nik, tb_usulan_pengabmas.judul_pengabmas, tb_usulan_pengabmas.id_usulan, tb_reviewer_pengabmas.* 
        from users
        JOIN tb_usulan_pengabmas ON users.nik = tb_usulan_pengabmas.id_dosen
        JOIN tb_reviewer_pengabmas ON tb_usulan_pengabmas.id_usulan = tb_reviewer_pengabmas.id_usulan
    ...
    {
        $data = DB::select('select tb_usulan_penelitian.*, tb_lookbook_penelitian.id as id_lookbook 
        from tb_usulan_penelitian 
    ...
    {
        $data = DB::select('select tb_usulan_pengabmas.*, tb_lookbook_pengabmas.id as id_lookbook 
        from tb_usulan_pengabmas 
