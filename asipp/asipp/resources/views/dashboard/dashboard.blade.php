...
<div class="alert alert-danger" role="alert">
    <i class="fas fa-exclamation-triangle"></i> Tidak dapat mengirimkan Email notifikasi, Mohon atur pengaturan Email SMTP (Email Host, Port, Username, Password) di .env terlebih dahulu. File .env terletak di direktori paling luar project laravel. <a href="https://laravel.com/docs/5.8/configuration" target="_blank">Selengkapnya</a>
</div>
@endif
<div class="row">
    <div class="col-md-12">
