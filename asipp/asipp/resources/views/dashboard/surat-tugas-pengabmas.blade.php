                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="judul_pengabmas" type="text" class="form-control{{ $errors->has('judul_pengabmas') ? ' is-invalid' : '' }}" name="judul_pengabmas" value="{{ $row->judul_pengabmas }}" readonly="readonly" autofocus required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="lama_pengabmas" type="text" class="form-control{{ $errors->has('lama_pengabmas') ? ' is-invalid' : '' }}" name="lama_pengabmas" value="{{ old('lama_pengabmas') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
