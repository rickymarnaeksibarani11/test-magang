...
<div class="tab-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="judul_penelitian" type="text" class="form-control{{ $errors->has('judul_penelitian') ? ' is-invalid' : '' }}" name="judul_penelitian" value="{{ $row->judul_penelitian }}" readonly="readonly" autofocus required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="tempat" type="text" class="form-control{{ $errors->has('tempat') ? ' is-invalid' : '' }}" name="tempat" value="{{ old('tempat') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="lama_penelitian" type="text" class="form-control{{ $errors->has('lama_penelitian') ? ' is-invalid' : '' }}" name="lama_penelitian" value="{{ old('lama_penelitian') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="keperluan" type="text" class="form-control{{ $errors->has('keperluan') ? ' is-invalid' : '' }}" name="keperluan" value="{{ old('keperluan') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="transport" type="text" class="form-control{{ $errors->has('transport') ? ' is-invalid' : '' }}" name="transport" value="{{ old('transport') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="nama_ketua" type="text" class="form-control{{ $errors->has('nama_ketua') ? ' is-invalid' : '' }}" name="nama_ketua" value="{{ $row->nama_ketua }}" autofocus required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi" type="text" class="form-control{{ $errors->has('afiliasi') ? ' is-invalid' : '' }}" name="afiliasi" value="{{ old('afiliasi') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="anggota_internal1" type="text" class="form-control{{ $errors->has('anggota_internal1') ? ' is-invalid' : '' }}" name="anggota_internal1" value="{{ $row->anggota_internal1 }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_internal1" type="text" class="form-control{{ $errors->has('afiliasi_internal1') ? ' is-invalid' : '' }}" name="afiliasi_internal1" value="{{ old('afiliasi_internal1') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="anggota_internal2" type="text" class="form-control{{ $errors->has('anggota_internal2') ? ' is-invalid' : '' }}" name="anggota_internal2" value="{{ $row->anggota_internal2 }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_internal2" type="text" class="form-control{{ $errors->has('afiliasi_internal2') ? ' is-invalid' : '' }}" name="afiliasi_internal2" value="{{ old('afiliasi_internal2') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="anggota_internal3" type="text" class="form-control{{ $errors->has('anggota_internal3') ? ' is-invalid' : '' }}" name="anggota_internal3" value="{{ $row->anggota_internal3 }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_internal3" type="text" class="form-control{{ $errors->has('afiliasi_internal3') ? ' is-invalid' : '' }}" name="afiliasi_internal3" value="{{ old('afiliasi_internal3') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="anggota_internal4" type="text" class="form-control{{ $errors->has('anggota_internal4') ? ' is-invalid' : '' }}" name="anggota_internal4" value="{{ $row->anggota_internal4 }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_internal4" type="text" class="form-control{{ $errors->has('afiliasi_internal4') ? ' is-invalid' : '' }}" name="afiliasi_internal4" value="{{ old('afiliasi_internal4') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_eksternal1" type="text" class="form-control{{ $errors->has('afiliasi_eksternal1') ? ' is-invalid' : '' }}" name="afiliasi_eksternal1" value="{{ old('afiliasi_eksternal1') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_eksternal2" type="text" class="form-control{{ $errors->has('afiliasi_eksternal2') ? ' is-invalid' : '' }}" name="afiliasi_eksternal2" value="{{ old('afiliasi_eksternal2') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_eksternal3" type="text" class="form-control{{ $errors->has('afiliasi_eksternal3') ? ' is-invalid' : '' }}" name="afiliasi_eksternal3" value="{{ old('afiliasi_eksternal3') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_eksternal4" type="text" class="form-control{{ $errors->has('afiliasi_eksternal4') ? ' is-invalid' : '' }}" name="afiliasi_eksternal4" value="{{ old('afiliasi_eksternal4') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_mahasiswa" type="text" class="form-control{{ $errors->has('afiliasi_mahasiswa') ? ' is-invalid' : '' }}" name="afiliasi_mahasiswa" value="{{ old('afiliasi_mahasiswa') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_alumni" type="text" class="form-control{{ $errors->has('afiliasi_alumni') ? ' is-invalid' : '' }}" name="afiliasi_alumni" value="{{ old('afiliasi_alumni') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="afiliasi_admin" type="text" class="form-control{{ $errors->has('afiliasi_admin') ? ' is-invalid' : '' }}" name="afiliasi_admin" value="{{ old('afiliasi_admin') }}" autofocus>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <h5 class="card-title">Download Surat Tugas</h5>
