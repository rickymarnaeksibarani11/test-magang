                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label for="nama_ketua" class="col-md-4 col-form-label text-md-right">{{ __('Nama Ketua + Gelar*') }}</label>
                            <div class="col-md-8">
                                <input id="nama_ketua" type="text" class="form-control{{ $errors->has('nama_ketua') ? ' is-invalid' : '' }}" name="nama_ketua" value="{{ old('nama_ketua') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="admin" type="text" class="form-control{{ $errors->has('admin') ? ' is-invalid' : '' }}" name="admin" value="{{ old('admin') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="mahasiswa" type="text" class="form-control{{ $errors->has('mahasiswa') ? ' is-invalid' : '' }}" name="mahasiswa" value="{{ old('mahasiswa') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="alumni" type="text" class="form-control{{ $errors->has('alumni') ? ' is-invalid' : '' }}" name="alumni" value="{{ old('alumni') }}" autofocus>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="judul_penelitian" type="text" class="form-control{{ $errors->has('judul_penelitian') ? ' is-invalid' : '' }}" name="judul_penelitian" value="{{ old('judul_penelitian') }}" required autofocus></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="luaran_wajib" class="custom-select">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="luaran_tambahan" class="custom-select">
                                    <option value="">- Pilih -</option>
                                    <option>Seminar Internasional</option>
                                    <option>Seminar Nasional</option>
                                    <option>Jurnal Internasional</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="jenis_penelitian" class="custom-select">
                                    <option value="">- Pilih -</option>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="nama_ketua" type="text" class="form-control{{ $errors->has('nama_ketua') ? ' is-invalid' : '' }}" name="nama_ketua" value="{{ $row->nama_ketua }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select type="select" name="anggota_internal1" class="custom-select">
                                    <option value="">- Pilih Anggota -</option>
                                    @foreach($dosen as $row)
                                    <option value="{{$row->name}}">{{$row->name}}</option>
                                    @endforeach
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="judul_penelitian" type="text" class="form-control{{ $errors->has('judul_penelitian') ? ' is-invalid' : '' }}" name="judul_penelitian" required autofocus>{{ $row->judul_penelitian }}</textarea>
                                @if ($errors->has('judul_penelitian'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('judul_penelitian') }}
                                </div>
