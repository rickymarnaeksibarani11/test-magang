                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="judul_pengabmas" type="text" class="form-control{{ $errors->has('judul_pengabmas') ? ' is-invalid' : '' }}" name="judul_pengabmas" value="{{ old('judul_pengabmas') }}" required autofocus></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select type="select" id="exampleCustomSelect" name="jenis_pengabmas" class="custom-select">
                                    <option value="">- Pilih -</option>
