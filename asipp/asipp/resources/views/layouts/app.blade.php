...
<head>
    ...
    <title>ASIPP - Aplikasi Sistem Informasi Penelitian dan Pengabdian Masyarakat</title>
    <meta name="description" content="Aplikasi Sistem Informasi Penelitian dan Pengabdian Masyarakat">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top py-1 shadow-sm mb-4">
            <div class="container-fluid px-5">
                <a href="{{url('/')}}" class="navbar-brand">
                    ...
                    <h6><span class="h4 fw-bold">ASIPP</span><br /><span style="font-size: small;font-weight:400;">Aplikasi Sistem Informasi<br />Penelitian dan Pengabdian Masyarakat</span></h6>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link me-2 {{Request::is('/*') ? 'active' : ''}}" aria-current="page" href="{{url('/')}}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-2 {{Request::is('pengumuman*') ? 'active' : ''}}" href="{{url('pengumuman')}}">Pengumuman</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-2 {{Request::is('halaman-unduh*') ? 'active' : ''}}" href="{{url('halaman-unduh')}}">Panduan</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-info {{Request::is('login*') ? 'active' : ''}}" href="{{url('login')}}"><i class="fas fa-sign-in-alt"></i> Login</a>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="alert alert-warning py-3" role="alert">
                        <p class="marquee">Selamat Datang di ASIPP, Aplikasi Sistem Informasi Penelitian dan Pengabdian Masyarakat</p>
                    </div>
                    @else
                ...
                <div class="col-md-4">
                    <div class="card card-body mt-3">
                        ...
                        <form method="POST" action="{{ route('login') }}" novalidate>
                            ...
                            <div class="form-floating mb-4">
                                <input id="password" type="password" class="form-control rounded-4 {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Password') }}" name="password">
    ...
    <div class="bg-warning bg-gradient text-dark">
        <footer class="container-fluid px-5 py-5">
            <div class="row">
                <div class="col-md-6">
                    <h5>Menu</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="{{url('/')}}" class="nav-link p-0 text-dark">Home</a></li>
                        <li class="nav-item mb-2"><a href="{{url('pengumuman')}}" class="nav-link p-0 text-dark">Pengumuman</a></li>
                        <li class="nav-item mb-2"><a href="{{url('halaman-unduh')}}" class="nav-link p-0 text-dark">Panduan</a></li>
                    </ul>
                </div>
            ...
            <div class="d-flex justify-content-between pt-4 mt-4 border-top">
                <p>&copy; <?php echo date("Y"); ?> <strong>ITShop.id</strong> — Purwokerto, Jawa Tengah, Indonesia</p>
