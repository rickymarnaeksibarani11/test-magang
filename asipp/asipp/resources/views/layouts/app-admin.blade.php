...
<head>
    ...
    <title>ASIPP - Dashboard</title>
    <meta name="description" content="Sistem Informasi Penelitian dan Pengabdian Masyarakat">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{url('/dashboard')}}" class="brand-link">
                <img src="{{asset('assets/image/logo/logo.png')}}" alt="ASIPP" class="brand-image" style="opacity: .8">
                <span class="brand-text font-weight-light">ASIPP</span>
            </a>
            <div class="sidebar">
